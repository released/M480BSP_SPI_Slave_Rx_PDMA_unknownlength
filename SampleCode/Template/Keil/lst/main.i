...
uint8_t g_au8MasterToSlaveTestPattern[(64)]={0};
...
uint8_t g_au8SlaveRxBuffer[(64)]={0};
...
{
    ( ((1UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_ADC_Data_Ready))) : ((BitFlag&=~(uint32_t)(1<<flag_ADC_Data_Ready))));
    ((((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)))->STATUS2 = ((0x1ul << (0))));       
}

unsigned int ADC_ReadChannel(void)
{
	uint32_t ModuleMask = (0x00000001UL) ;		
    ...
    ((((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)))->INTSRC[(0)] |= ((ModuleMask)));

	( ((0UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_ADC_Data_Ready))) : ((BitFlag&=~(uint32_t)(1<<flag_ADC_Data_Ready))));				
	((((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)))->SWTRG = ((ModuleMask)));						
	
	while(((((((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)))->STATUS0 & (0xfffful << (0))) | (((((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)))->STATUS1 & (0x7ul << (0))) << 16)) & ((ModuleMask))) != (ModuleMask));
	
	get_adc = ((((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)))->DAT[(ModuleNum)] & (0xfffful << (0)));
...
void ADC_InitChannel(uint8_t ch)
{
    ...
    EADC_SetExtendSampleTime(((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)), ch, 0x3F);
	
	EADC_ConfigSampleModule(((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)), ModuleNum, (2UL<<(16)), ch);
...
#line 388 "..\\main.c"
    ...
    {
        if((((uint32_t)(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->TDSTS)) & ((1 << (14)) | (1 << (15)))) == ((1 << (14)) | (1 << (15))))
        {
             
            ((uint32_t)(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->TDSTS = (((1 << (14)) | (1 << (15))))));

			
			( ((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL))))->PDMACTL &= ~(0x1ul << (1)) );			
        }        		
    }
    else if (status & ((0x1ul << (8)) | (0x1ul << (9))))      
    {
        ((uint32_t)(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->INTSTS = (1 << (((14)) + 8))));
        ((uint32_t)(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->INTSTS = (1 << (((15)) + 8))));
    }
    else
    {
...
{
	reset_buffer(g_au8SlaveRxBuffer , 0x00, (64));
}
...
void SPI_Slave_Rx_PDMA_Enable(void)
{
	...
	PDMA_SetTransferCnt(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)),(15), 0x00000000UL, (64));
	PDMA_SetTransferAddr(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)),(15), (uint32_t)&((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL))->RX, 0x00000300UL, (uint32_t)g_au8SlaveRxBuffer, 0x00000000UL);		
	 
	PDMA_SetTransferMode(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)),(15), 23UL, (0UL), 0);
	((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL)))->PDMACTL |= (0x1ul << (1)));	

	PDMA_EnableInt(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)), (15), 0x00000000UL);
}
...
void SPI_Slave_Rx_PDMA_Init(void)
{
    ...
    PDMA_Open(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)), ((1 << (14)) | (1 << (15))));
    ...
    PDMA_SetBurstType(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)),(15), 0x00000004UL, 0);
...
void SPI0_IRQHandler(void)
{
	...
	if (((((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL))))->STATUS & (0x1ul << (3))) >> (3)))
	{



		packetlen = ((uint32_t)((((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->DSCT[((15))]. CTL&(0xfffful << (16))) >> (16)));
		packetlen = ((64) - packetlen) -1;
		( ((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL))))->PDMACTL &= ~(0x1ul << (1)) );
		
		( ((1UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_SPI_Slave_RX))) : ((BitFlag&=~(uint32_t)(1<<flag_SPI_Slave_RX))));
		...
		(((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL))))->STATUS |= (0x1ul << (3)));			
	}
}
...
{
	SYS_ResetModule(((4UL<<24) | (13)));
    SPI_Open((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL))), ((0x1ul << (18))), ((0x1ul << (2))), 8, (uint32_t)0);

	SPI_ClearRxFIFO((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL))));

	SPI_SetFIFO((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL))) , 4 , 4);

	SPI_EnableInt((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL))),(0x004U) );
    (((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL))))->TX = (0xFFFFFFFF));     
...
void SPI_Master_TX(SPI_T *spi , uint8_t *buffer , uint32_t len)
{
    ...
    (((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL))))->SSCTL = (((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL))))->SSCTL & (~((0x1ul << (3)) | (0x1ul << (2))))) | (0x1ul << (0)));

#line 512 "..\\main.c"
    while (TxDataCount < len)
    {
        ((spi)->TX = (buffer[TxDataCount++]));
		while(( ((spi)->STATUS & (0x1ul << (0)))>>(0) ));
    }
...
void SPI_Master_Init(void)
{
    ...
    SPI_DisableAutoSS((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL))));
}
...
{	
	...
	reset_buffer(g_au8MasterToSlaveTestPattern , 0x00, (64));

	datalen = random(1 , (64)-4);	
	...
	SPI_Master_TX((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x22000UL))) , g_au8MasterToSlaveTestPattern,packetsize);

}

void loop(void)
{
	if ((((BitFlag&(uint32_t)(1<<flag_SPI_Slave_RX))?1:0)))
	{
		( ((0UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_SPI_Slave_RX))) : ((BitFlag&=~(uint32_t)(1<<flag_SPI_Slave_RX))));
...
void SYS_Init(void)
{
   ...
   CLK_EnableModuleClock(((0UL<<30)|(0x0UL<<28)|(0x0UL<<25)|(0x0UL<<20)|(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(1UL<<0)));
    ...
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPL &= ~((0xful << (0)) | (0xful << (4)) | (0xful << (8)) | (0xful << (12)));
    ...
    GPIO_SetSlewCtl(((GPIO_T *) (((uint32_t)0x40000000) + 0x04000UL)), 0xF, 0x1UL);

     
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPC_MFPL &= ~((0xful << (0)) | (0xful << (4)) | (0xful << (8)) | (0xful << (12)));
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPC_MFPL |= ((0x07UL<<(0)) | (0x07UL<<(4)) | (0x07UL<<(8))| (0x07UL<<(12)));	

     
    ((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL))->SMTEN |= (0x1ul << (1));

     
    GPIO_SetSlewCtl(((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL)), 0xF, 0x1UL);	

    ((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL))->MODE &= ~((0x3ul << (28)));

    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPB_MFPH &= ~((0xful << (24)));
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPB_MFPH |= ((0x01UL<<(24)));

     
    ((((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)))->DINOFF |= (((0x00004000UL))<<16));

     
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->IVSCTL |= (0x1ul << (0));
